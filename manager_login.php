...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $table_check = mysqli_query($conn, "SHOW TABLES LIKE 'staff'");
    if (!$table_check) {
        die("Error checking for staff table: " . mysqli_error($conn));
    }
    
    if (mysqli_num_rows($table_check) == 0) {
        die("The staff table does not exist. Please run setup_database.php first.");
    }
    
    $sql = "SELECT * FROM staff WHERE username = '$username' AND password = '$password' AND role = 'manager'";
...
<head>
    ...
    <title>ELITE BANK - Manager Login</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <h2 class="login-title">Manager Login</h2>
